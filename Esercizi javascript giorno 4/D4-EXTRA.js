...
function shoppingCartTotal(x){
    ...
    console.log("totale del carrello: " + total)
}
...
/* SCRIVI QUI LA TUA RISPOSTA */
let obj = {price: 30 , name: "name4", id: 80 , quantity: 4 ,}
...
/* SCRIVI QUI LA TUA RISPOSTA */
function maxShoppingCart(y){
    let maxItem = y[0];
    for(let i = 1; i<y.length; i++){
        if(y[i].price>maxItem.price){
            maxItem = y[i];
        }
    }
    console.log(maxItem)
